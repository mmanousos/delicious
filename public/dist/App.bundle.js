  ...
  _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (res) {
    ...
    markers.forEach(function (marker) {
      return marker.addListener("click", function () {
        var html = "\n        <div class=\"popup\">\n          <a href=\"/store/" + this.place.slug + "\">\n            <img src=\"/uploads/" + (this.place.photo || "store.png") + "\" alt=\"" + this.place.name + "\" />\n            <p><span style=\"font-weight: 400;\">" + this.place.name + "</span> - " + this.place.location.address + "</p>\n          </a>\n        </div>";
...
function typeAhead(search) {
  ...
  var searchInput = search.querySelector('input[name="search"]'); // find the search input field
  var searchResults = search.querySelector(".search__results"); // find the div with `search__results` class
